...
function ProfileModal({
  ...
  const hasUnsavedChanges = () => {
    ...
    return (
      hasNameChange || hasPasswordChange || hasImageChange || hasImageRemoval
    );
  };
  ...
  }, [email, methods, name, profilePicture, setCurrentImage, setOriginalImage]);

  return (
    <>
      {/* Backdrop for click-outside */}
      <Sheet open={isOpen} onOpenChange={handleBackdropClick}>
        <SheetContent>
          <section className=" bg-white h-screen py-4  overflow-y-auto">
