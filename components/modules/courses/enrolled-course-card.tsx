...
export default function EnrolledCourseCard({
    ...
    return (
        <Link href={`/teacher/courses/${course.id}`}>
            <article className="group relative flex h-full flex-col overflow-hidden rounded-xl border-2 border-primary-color bg-white shadow-sm transition-all duration-300 hover:shadow-xl hover:border-primary-color/80 hover:-translate-y-1 cursor-pointer">
                <div className="absolute top-4 right-4 z-10">
                    <div className="flex items-center gap-1.5 bg-green-100 text-green-700 px-3 py-1.5 rounded-full text-xs font-semibold shadow-sm transition-all group-hover:bg-green-500 group-hover:text-white">
                ...
                <div className="flex-1 p-6 space-y-4">
                    <div className="flex items-start justify-between gap-4">
                        <div className="flex-1 min-w-0">
                            ...
                            <h3 className="text-xl font-bold text-gray-900 pr-20 line-clamp-2 group-hover:text-primary-color transition-colors">
                                {course.name}
                            </h3>
                        </div>
                    </div>
