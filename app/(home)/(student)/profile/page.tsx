...
import Card from '@/app/modules/STUDENT/profile/Card';
...
import MyAnswersTable, {
    MyAnswers,
} from '@/app/modules/STUDENT/profile/MyAnswersTable';
import Filters from '@/app/components/common/Filters';
import ResourceCard, {
    Resource,
} from '@/app/modules/STUDENT/profile/ResourceCard';
...
function page() {
    return (
        <div>
            ...
            <div>
                <h1 className="font-semibold text-2xl mb-4">My Answers</h1>
            ...
            <div>
                <h1 className="font-semibold text-2xl my-4">My Resources</h1>
                <div className="grid lg:grid-cols-3 gap-5">
                    {resources.map((resource) => (
                        <ResourceCard key={resource.id} card={resource} />
                    ))}
                </div>
            </div>
        </div>
