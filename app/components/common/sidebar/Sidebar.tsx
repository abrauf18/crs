...
import { Settings, Menu, X, LogOut, LayoutGrid } from "lucide-react";
        ...
        <section className="bg-light-gray md:p-3 md:fixed">
            <ul className="flex flex-col w-full items-center justify-center pt-5 h-screen mobile:hidden">
                ...
                <div className="flex flex-col justify-start items-center h-full">
                    <NavigationItem to="/" ItemIcon={LayoutGrid} itemText="Dashboard" />
                    <NavigationItem to="/video" ItemIcon={VideoIcon} itemText="Video" />
                    <NavigationItem to="/resources" ItemIcon={ResourceIcon} itemText="Resources" />
                    <NavigationItem to="#" ItemIcon={QueryIcon} itemText="Query" />
                    <NavigationItem to="#" ItemIcon={StandardIcon} itemText="Standard" />
                    <NavigationItem to="/users" ItemIcon={UserIcon} itemText="User’s" />
                </div>
                <div className="mb-2">
                    <NavigationItem to="#" ItemIcon={Settings} itemText="Settings" />
                    <NavigationItem to="#" ItemIcon={LogOut} itemText="Logout" />
                </div>
            </ul>
