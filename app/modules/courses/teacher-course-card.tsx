...
export default function TeacherCourseCard({ course }: TeacherCourseCardProps) {
    ...
    return (
        <Link href={`/teacher/courses/${course.id}`}>
            <article className="group relative flex h-full flex-col overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-sm transition-all duration-300 hover:shadow-md cursor-pointer">
