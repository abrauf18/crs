...
const Dashboard = () => {
    return (
        <section className="flex flex-col w-full scroll-smooth mobile:mt-12">
            <Header headerText="Hello John Doe!" tagline="Here’s a Quick Overview" Icon={WavingHandIcon} />
            <div className="grid mobile:grid-col-1 sm:grid-cols-2 md:grid-cols-4 gap-4 mt-4 mobile:place-items-center">
                ...
                <Card Icon={VideoIcon} cardText="Video Uploads" count={200} isActive={true} />
                <Card Icon={ResourceIcon} cardText="Total Resources" count={150} />
