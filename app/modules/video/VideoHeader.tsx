...
function VideoHeader({ text }: VideoHeaderProps): JSX.Element {
    ...
    return (
        <div className="flex mobile:flex-col justify-between items-center my-7">
            ...
            <div className="flex">
                ...
                <div className="px-2 py-3 border text-sm text-white bg-primary-color rounded-lg flex items-center justify-between">
